...
//Функция, чтобы не удалять один и тот же элемент
...
document.querySelectorAll('.box').forEach(item => {
    ...
    item.addEventListener('click', function () {
        ...
        // Для того чтобы удалить противоположный элемент
        ...
        // Переключение призыва к действию
        ...
        if (tog % 2 == 0) {
            document.getElementById('tog').innerText = "Ход чёрных!"
            whosTurn('B')
        }
